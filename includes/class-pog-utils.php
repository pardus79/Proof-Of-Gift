...
class POG_Utils {
	...
	public static function add_change_token_to_email( $order, $sent_to_admin, $plain_text, $mode = 'store_currency' ) {
		...
		if ( $plain_text ) {
			...
			echo esc_html__( 'Redemption URL:', 'proof-of-gift' ) . ' ' . esc_html( $application_url ) . "\n\n";
			echo esc_html__( 'Visit the URL above to automatically apply this token to your cart.', 'proof-of-gift' ) . "\n\n";
		} else {
			?>
			...
			<p>
				<?php esc_html_e( 'Redemption URL:', 'proof-of-gift' ); ?><br>
